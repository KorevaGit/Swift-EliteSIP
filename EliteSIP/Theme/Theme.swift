...
enum Theme {
    ...
    enum Metrics {
        ...
        /// Значок исхода в строке истории.
        ///
        /// Крупный: он единственный, что различает четыре состояния звонка, и
        /// читается первым. Стрелка внутри — половина диаметра.
        static let historyBadgeSize: CGFloat = 22
