...
enum Theme {
    ...
    enum Metrics {
        ...
        /// Правая колонка строки истории: время и исход под ним.
        ///
        ...
        /// нельзя.
        ///
        /// 72 — по самому длинному, что здесь стоит: «пропущен» под «15:58».
        /// Первый заход был на 96 «под причину отказа», и живое окно его
        /// опровергло: причины в эту ширину всё равно не влезают («отказ 503
        /// service…»), а от попытки их вместить колонка отъедала место у имени
        /// собеседника. Причина уехала в подзаголовок, где ширина есть.
        static let historyOutcomeColumn: CGFloat = 72
