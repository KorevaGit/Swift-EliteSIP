...
// Кирпичи раскладки (`SettingsSection`, `SettingsRow`, `SettingsToggleRow`,
// `SettingsNote`, `SettingsResolvedValue`, `SettingsButtonsRow`,
// `SettingsIndented`, `SettingsDivider`) переехали в `SettingsKit.swift`:
// с этапа 5 на них собрано и окно «Управление», а копия означала бы
// расхождение — ровно то, из-за которого два окна успели разойтись по
// текстам одной и той же настройки.
