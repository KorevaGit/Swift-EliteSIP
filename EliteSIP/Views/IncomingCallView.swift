...
struct IncomingCallView: View {
    ...
    private var caller: some View {
        ...
        case .selfCall:
            // Тот же ярус, что у раздачи: главное место занимает заголовок,
            // номер скрыт. Своя вёрстка здесь была бы третьим описанием одной
            // и той же фигуры.
            Text(IncomingCallSubject.dealTitle)
                .font(Theme.Text.incomingTitle)
                .lineLimit(1)
                .minimumScaleFactor(0.6)
