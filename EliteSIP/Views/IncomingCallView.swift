...
///
/// Словарь очередей при этом остаётся и проверяется первым: он всё ещё верен
/// для диалплана, который CallerID подменяет, — и заказчик, поправивший
/// диалплан, не должен из-за этого чинить ещё и клиент.
