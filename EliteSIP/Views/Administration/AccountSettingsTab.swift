...
struct AccountSettingsTab: View {
    ...
    var body: some View {
        // Панель — первым блоком, над профилями: если машиной управляют
        // отсюда, это главное, что администратор должен узнать про неё,
        // открыв окно. До 25 августа 2026 блок жил в отдельном разделе
        // «Предустановки», вместе с локальными снимками настроек, которых
        // больше нет.
        PanelStatusCard()
