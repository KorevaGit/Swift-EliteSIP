...
struct PresetsTab: View {
    ...
    var body: some View {
        ...
        SettingsSection("Снять с этой машины") {
            ...
            SettingsNote("""
                Предустановка — про отдел, конфигурация — про одно рабочее место. Первой заводят \
                новые машины по образцу, второй переносят человека со всем его содержимым, \
                включая номер и пароль. Конфигурация выгружается в «Обслуживании».
                """)
        }
