...
extension AppModel {
    ...
    /// исходом, здесь — только номера и только исходящие. Звонка из окна
    /// истории с 19 августа 2026 нет вовсе, и эти стрелки — единственный
    /// быстрый повтор: «наберу тот же номер ещё раз», когда линия была занята
    /// или ответили не там.
    ///
