...
extension AppModel {
    ...
    func resetMachine() {
        ...
        // Привязка — вместе с настройками, а не отдельным решением: в ней
        // ключ машины и пароль SIP, и пережить стирание настроек она не имеет
        // права. Сброшенная машина покажет новый код, и её привяжут заново.
        PairingStore.clear()
