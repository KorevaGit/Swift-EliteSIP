...
final class AppModel: ObservableObject {
    ...
    /// Прежний installation_id машины, переведённой на новый ключ посреди
    /// разговора: пакет ещё ждёт, а личность уже новая. Нужен только журналу
    /// и сразу запрошенному доступу по концу разговора.
    var previousReflashMachine: String?
