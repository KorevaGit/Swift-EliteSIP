...
- [ ] **M2d** — транспорт удалённого профиля: подтвердить VPN-маршрут либо
      принять открытый UDP как осознанное решение. Блокирует не код, а выпуск на
      удалённые рабочие места — [docs/ROADMAP.md](docs/ROADMAP.md)
