...
записано в [docs/STATE.md](docs/STATE.md) и в файле самого этапа. Этапы без
пометки писались после этой волны, и своего аудита у них ещё не было: это
**M1.5**, **M1.6**, **M2c**, **M2d**, **M7a** и **M7b**.
