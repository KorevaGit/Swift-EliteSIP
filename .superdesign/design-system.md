...
- generous outer margins and deliberate empty space;
...
- Desktop content is fluid and wide: 80px side gutters, maximum useful width 1600–1800px. Do not constrain working tables to a narrow centered column.
...
- Page title: 48px / 1.12 desktop, 34px / 1.15 tablet, 28px / 1.2 mobile.
...
- Table/form heading: 18px / 1.35.
- Body and controls: 16px / 1.45.
- Caption/metadata: 14px / 1.4, gray.
- Avoid uppercase micro-labels, excessive tracking, and tiny 11–12px dashboard text.

## Spacing and geometry

- Base unit: 8px.
- Desktop page gutter: 80px; tablet: 40px; mobile: 20px.
- Section rhythm: 56–80px between major regions.
- Internal content gaps: 16px, 24px, or 40px.
- Controls: 48px minimum height.
...
- Header row uses muted 14px labels; body rows are 16px with 56–64px height and hairline separators.
...
- Forms use clear labels above inputs, generous vertical spacing, and simple white or quiet-gray fields with a 1px hairline.
