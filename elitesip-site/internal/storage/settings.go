...
const (
	// SettingAdminPassword — административный пароль конторы, общий на все
	// машины. Уезжает в пакет активации; смена перестаёт требовать выпуска
	// приложения, где он сегодня вшивается фазой сборки.
	SettingAdminPassword = "admin_password"
)
